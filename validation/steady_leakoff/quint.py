...
运行
----
    python validation/steady_leakoff/quint.py
"""
import os
import sys
...
from paths import output_path, SERIES_STEADY_LEAKOFF, CASE_QUINT
...
def run_validation():
    ...
    out_path = output_path(SERIES_STEADY_LEAKOFF, CASE_QUINT, "moc_leakoff.png")
    plt.savefig(out_path, dpi=130, bbox_inches='tight')
    print(f"\n图已保存: {out_path}")
    plt.close(fig)

    cep_path = output_path(SERIES_STEADY_LEAKOFF, CASE_QUINT, "cepstrum_standard.png")
    ...
    json_path = output_path(SERIES_STEADY_LEAKOFF, CASE_QUINT, "moc_leakoff.json")
