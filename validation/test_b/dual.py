...
运行
----
    python wellbore_moc_method/validate_moc_test_b_dual.py
"""
import os
import sys
...
from paths import output_path, SERIES_TEST_B, CASE_DUAL
...
def run_validation():
    ...
    out_path = output_path(SERIES_TEST_B, CASE_DUAL, "moc_leakoff.png")
    plt.savefig(out_path, dpi=130, bbox_inches='tight')
    print(f"\n图已保存: {out_path}")
    plt.close(fig)

    cep_path = output_path(SERIES_TEST_B, CASE_DUAL, "cepstrum_standard.png")
    ...
    json_path = output_path(SERIES_TEST_B, CASE_DUAL, "moc_leakoff.json")
