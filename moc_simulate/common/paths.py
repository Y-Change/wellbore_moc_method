# -*- coding: utf-8 -*-
"""
moc_simulate.common.paths

自研 MOC 方法目录与分级 output 路径统一管理
"""
...
COMMON_DIR = _CURRENT_DIR
PACKAGE_DIR = os.path.dirname(_CURRENT_DIR)
...
def moc_output_subdir(series: str, case: Optional[str] = None) -> str:
    ...
    Parameters
    ----------
    series : 验证系列，如 ``leakoff``、``cepstrum/kaiser_bessel``、``step01_joukowsky``
