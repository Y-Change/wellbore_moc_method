# -*- coding: utf-8 -*-
"""Same case alone / partners / order / pad length → float32 rel ≤ 1e-5."""
...
from dataset import (
    N_MAX, Round2Dataset, collate_predict, compute_norm, load_round1_manifest,
...
def test_batch_invariance():
    ...
    ds = Round2Dataset("train", cfg, man, case_ids=nested_ids(order, 3))
    ...
    # padding must not rewrite the valid physical tau
    ...
    print({
        ...
        "abs_partners": abs_p, "near_zero": near_zero, "status": "PASS",
    })
