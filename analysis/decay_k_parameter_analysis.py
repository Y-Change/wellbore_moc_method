...
def main():
    ...
    # Filter only steady
    rows = [r for r in all_rows if r['friction_model'] == 'steady']
    ...
    # Set y limit for R2 to show it's near 1
    ...
    fig.suptitle('Analysis of Decay Parameters (Steady Friction, 2D Cepstrum)', fontsize=14)
    fig.tight_layout()
    
    out_dir = output_path(SERIES_DECAY_REGRESSION, 'plots', '')
    os.makedirs(out_dir, exist_ok=True)
    save_path = os.path.join(out_dir, 'steady_k_parameter_analysis.png')
