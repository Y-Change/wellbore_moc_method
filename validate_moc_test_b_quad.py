...
def run_validation():
    ...
    out_path = os.path.join(out_dir, "test_b_quad_fracture_leakoff.png")
    plt.savefig(out_path, dpi=130, bbox_inches='tight')
    print(f"\n图已保存: {out_path}")
    plt.close(fig)

    cep_path = os.path.join(out_dir, "test_b_quad_cepstrum.png")
    ...
    json_path = os.path.join(out_dir, "test_b_quad_fracture_leakoff.json")
